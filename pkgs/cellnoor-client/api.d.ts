...
export interface components {
    schemas: {
        ...
        Row: {
            ...
            "Library Type": string;
            "Metric Name": string;
            "Metric Value": components["schemas"]["TenxCsvValue"];
        };
        /** @enum {string} */
        ...
        /**
         * @description A CSV value found in the `metrics_summary.csv` files produced by 10x
...
export type TenxCsvValue = components['schemas']['TenxCsvValue'];

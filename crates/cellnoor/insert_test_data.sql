...
values (uuid_nil(), 'chromium_run0', uuid_nil(), '1999-01-01T00:00:00Z', uuid_nil(), true);
...
values (uuid_nil(), 'cdna0', 'Gene Expression', '1999-01-01T00:00:00Z', uuid_nil(), 0);

insert into library (
    id, readable_id, cdna_id, single_index_set_name, number_of_sample_index_pcr_cycles, prepared_at
)
values (uuid_nil(), 'library0', uuid_nil(), 'single_index_set', 0, '1999-01-01T00:00:00Z');

insert into chromium_dataset (id, name, delivered_at)
values (uuid_nil(), 'singleplex_gene_expression_chromium_dataset', '1999-01-01T00:00:00Z');

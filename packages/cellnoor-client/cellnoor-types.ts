  ...
  "/institutions/search": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["InstitutionPredicateQuery"];
        };
      };
      responses: {
        200: {
    ...
    get: {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["SuspensionPoolCompact"][];
          };
        };
        401: {
          headers: {
    ...
    get: {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["SuspensionPoolDetailed"][];
          };
        };
        401: {
          headers: {
  ...
  "/suspension-pools/search": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["SuspensionPoolPredicateQuery"];
        };
      };
      responses: {
        200: {
  ...
  "/suspension-pools/{id}/measurements": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["NewSuspensionPoolMeasurement"];
        };
      };
      responses: {
        200: {
  ...
  "/chromium-runs/search": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["ChromiumRunPredicateQuery"];
        };
      };
      responses: {
        200: {
  ...
  "/cdna/{id}/measurements": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["NewNucleicAcidMeasurement"];
        };
      };
      responses: {
        200: {
    ...
    get: {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["ChromiumDatasetCompact"][];
          };
        };
        401: {
          headers: {
    ...
    post: {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json":
              components["schemas"]["ChromiumDatasetDetailed"];
          };
        };
        /** @description Failed to parse the request body as JSON */
        400: {
        ...
        default: {
          ...
          content: {
            "application/json":
              components["schemas"]["CreateChromiumDatasetError"];
          };
        };
      };
    };
  ...
  "/chromium-datasets/search": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json":
            components["schemas"]["ChromiumDatasetPredicateQuery"];
        };
      };
      responses: {
        200: {
    ...
    put: {
      ...
      responses: {
        ...
        default: {
          ...
          content: {
            "application/json":
              components["schemas"]["UpdateChromiumDatasetError"];
          };
        };
      };
    };
...
export interface components {
  schemas: {
    ...
    CountingMethod:
      | "bright_field"
      | "acridine_orange_propidium_iodide"
      | "trypan_blue";
    ...
    Fixative:
      | components["schemas"]["DithiobisSuccinimidylpropionate"]
      | components["schemas"]["FormaldehydeDerivative"];
    /** @description A simple comparison operator. */
    FixativeOperator: {
    ...
    NewChromiumAssay: {
      ...
      library_type_specifications:
        components["schemas"]["LibraryTypeSpecification"][];
      name: string;
      protocol_url: string;
    ...
    OrderByApiKeyFieldSet:
      | components["schemas"]["OrderByApiKeyField"]
      | components["schemas"]["OrderByApiKeyField"][];
    OrderByCdnaField: {
      /** @default true */
      desc?: boolean;
    ...
    OrderByCdnaFieldSet:
      | components["schemas"]["OrderByCdnaField"]
      | components["schemas"]["OrderByCdnaField"][];
    ...
    OrderByChromiumDatasetFieldSet:
      | components["schemas"]["OrderByChromiumDatasetField"]
      | components["schemas"]["OrderByChromiumDatasetField"][];
    ...
    OrderByChromiumRunFieldSet:
      | components["schemas"]["OrderByChromiumRunField"]
      | components["schemas"]["OrderByChromiumRunField"][];
    ...
    OrderByInstitutionFieldSet:
      | components["schemas"]["OrderByInstitutionField"]
      | components["schemas"]["OrderByInstitutionField"][];
    OrderByLibraryField: {
      /** @default true */
      desc?: boolean;
    ...
    OrderByLibraryFieldSet:
      | components["schemas"]["OrderByLibraryField"]
      | components["schemas"]["OrderByLibraryField"][];
    OrderByPersonField: {
      /** @default false */
      desc?: boolean;
    ...
    OrderByPersonFieldSet:
      | components["schemas"]["OrderByPersonField"]
      | components["schemas"]["OrderByPersonField"][];
    OrderByProjectField: {
      /** @default true */
      desc?: boolean;
    ...
    OrderByProjectFieldSet:
      | components["schemas"]["OrderByProjectField"]
      | components["schemas"]["OrderByProjectField"][];
    OrderByServiceField: {
      /** @default true */
      desc?: boolean;
    ...
    OrderByServiceFieldSet:
      | components["schemas"]["OrderByServiceField"]
      | components["schemas"]["OrderByServiceField"][];
    ...
    OrderBySpecimenFieldSet:
      | components["schemas"]["OrderBySpecimenField"]
      | components["schemas"]["OrderBySpecimenField"][];
    ...
    OrderBySuspensionFieldSet:
      | components["schemas"]["OrderBySuspensionField"]
      | components["schemas"]["OrderBySuspensionField"][];
    ...
    OrderBySuspensionPoolFieldSet:
      | components["schemas"]["OrderBySuspensionPoolField"]
      | components["schemas"]["OrderBySuspensionPoolField"][];
    Parameter:
      | (
        & ({
    ...
    SpecimenPredicate: {
      ...
      thermal_preservation_method:
        components["schemas"]["ThermalPreservationMethodOperator"];
    } | {
    ...
    SuspensionSpecimenFields: {
      ...
      thermal_preservation_method:
        components["schemas"]["ControlledRateFreezing"];
    };
    SuspensionUpdate: {
      additional_data?: unknown;
      content: components["schemas"]["SuspensionContent"];
    ...
    ThermalPreservationMethod:
      | components["schemas"]["ControlledRateFreezing"]
      | components["schemas"]["FlashFreezing"];
    /** @description A simple comparison operator. */
...
export type ApiKeyPredicateFilter =
  components["schemas"]["ApiKeyPredicateFilter"];
export type ApiKeyPredicateQuery =
  components["schemas"]["ApiKeyPredicateQuery"];
export type ApiKeyUpdate = components["schemas"]["ApiKeyUpdate"];
export type ArrayOfLibraryTypeOperator =
  components["schemas"]["Array_of_LibraryTypeOperator"];
export type AuthError = components["schemas"]["AuthError"];
export type BlockEmbeddingMatrix =
  components["schemas"]["BlockEmbeddingMatrix"];
export type BlockEmbeddingMatrixOperator =
  components["schemas"]["BlockEmbeddingMatrixOperator"];
...
export type ChromiumDatasetCompact =
  components["schemas"]["ChromiumDatasetCompact"];
export type ChromiumDatasetDetailed =
  components["schemas"]["ChromiumDatasetDetailed"];
export type ChromiumDatasetDetailedLinks =
  components["schemas"]["ChromiumDatasetDetailedLinks"];
export type ChromiumDatasetField =
  components["schemas"]["ChromiumDatasetField"];
export type ChromiumDatasetParsedFile =
  components["schemas"]["ChromiumDatasetParsedFile"];
export type ChromiumDatasetPredicate =
  components["schemas"]["ChromiumDatasetPredicate"];
export type ChromiumDatasetPredicateFilter =
  components["schemas"]["ChromiumDatasetPredicateFilter"];
export type ChromiumDatasetPredicateInner =
  components["schemas"]["ChromiumDatasetPredicateInner"];
export type ChromiumDatasetPredicateQuery =
  components["schemas"]["ChromiumDatasetPredicateQuery"];
export type ChromiumDatasetRecord =
  components["schemas"]["ChromiumDatasetRecord"];
...
export type ChromiumRunPredicate =
  components["schemas"]["ChromiumRunPredicate"];
export type ChromiumRunPredicateFilter =
  components["schemas"]["ChromiumRunPredicateFilter"];
export type ChromiumRunPredicateInner =
  components["schemas"]["ChromiumRunPredicateInner"];
export type ChromiumRunPredicateQuery =
  components["schemas"]["ChromiumRunPredicateQuery"];
...
export type FormaldehydeDerivative =
  components["schemas"]["FormaldehydeDerivative"];
...
export type InstitutionPredicate =
  components["schemas"]["InstitutionPredicate"];
export type InstitutionPredicateFilter =
  components["schemas"]["InstitutionPredicateFilter"];
export type InstitutionPredicateQuery =
  components["schemas"]["InstitutionPredicateQuery"];
...
export type LibraryPredicateFilter =
  components["schemas"]["LibraryPredicateFilter"];
export type LibraryPredicateInner =
  components["schemas"]["LibraryPredicateInner"];
export type LibraryPredicateQuery =
  components["schemas"]["LibraryPredicateQuery"];
export type LibraryType = components["schemas"]["LibraryType"];
export type LibraryTypeArrayOperator =
  components["schemas"]["LibraryTypeArrayOperator"];
export type LibraryTypeOperator = components["schemas"]["LibraryTypeOperator"];
export type LibraryTypeSpecification =
  components["schemas"]["LibraryTypeSpecification"];
...
export type MultiplexingTagPredicate =
  components["schemas"]["MultiplexingTagPredicate"];
export type MultiplexingTagType = components["schemas"]["MultiplexingTagType"];
export type MultiplexingTagTypeOperator =
  components["schemas"]["MultiplexingTagTypeOperator"];
export type Nanogram = components["schemas"]["Nanogram"];
export type NanogramConcentration =
  components["schemas"]["NanogramConcentration"];
...
export type NewNucleicAcidMeasurement =
  components["schemas"]["NewNucleicAcidMeasurement"];
...
export type NewSpecimenMeasurement =
  components["schemas"]["NewSpecimenMeasurement"];
export type NewStandardGemWell = components["schemas"]["NewStandardGemWell"];
export type NewStandardOrOcmGemWell =
  components["schemas"]["NewStandardOrOcmGemWell"];
export type NewSuspension = components["schemas"]["NewSuspension"];
export type NewSuspensionMeasurement =
  components["schemas"]["NewSuspensionMeasurement"];
export type NewSuspensionPool = components["schemas"]["NewSuspensionPool"];
export type NewSuspensionPoolMeasurement =
  components["schemas"]["NewSuspensionPoolMeasurement"];
export type NewTenxAssay = components["schemas"]["NewTenxAssay"];
export type NucleicAcidMeasurementData =
  components["schemas"]["NucleicAcidMeasurementData"];
...
export type OrderByApiKeyFieldSet =
  components["schemas"]["OrderByApiKeyFieldSet"];
...
export type OrderByChromiumDatasetField =
  components["schemas"]["OrderByChromiumDatasetField"];
export type OrderByChromiumDatasetFieldSet =
  components["schemas"]["OrderByChromiumDatasetFieldSet"];
export type OrderByChromiumRunField =
  components["schemas"]["OrderByChromiumRunField"];
export type OrderByChromiumRunFieldSet =
  components["schemas"]["OrderByChromiumRunFieldSet"];
export type OrderByInstitutionField =
  components["schemas"]["OrderByInstitutionField"];
export type OrderByInstitutionFieldSet =
  components["schemas"]["OrderByInstitutionFieldSet"];
export type OrderByLibraryField = components["schemas"]["OrderByLibraryField"];
export type OrderByLibraryFieldSet =
  components["schemas"]["OrderByLibraryFieldSet"];
export type OrderByPersonField = components["schemas"]["OrderByPersonField"];
export type OrderByPersonFieldSet =
  components["schemas"]["OrderByPersonFieldSet"];
export type OrderByProjectField = components["schemas"]["OrderByProjectField"];
export type OrderByProjectFieldSet =
  components["schemas"]["OrderByProjectFieldSet"];
export type OrderByServiceField = components["schemas"]["OrderByServiceField"];
export type OrderByServiceFieldSet =
  components["schemas"]["OrderByServiceFieldSet"];
export type OrderBySpecimenField =
  components["schemas"]["OrderBySpecimenField"];
export type OrderBySpecimenFieldSet =
  components["schemas"]["OrderBySpecimenFieldSet"];
export type OrderBySuspensionField =
  components["schemas"]["OrderBySuspensionField"];
export type OrderBySuspensionFieldSet =
  components["schemas"]["OrderBySuspensionFieldSet"];
export type OrderBySuspensionPoolField =
  components["schemas"]["OrderBySuspensionPoolField"];
export type OrderBySuspensionPoolFieldSet =
  components["schemas"]["OrderBySuspensionPoolFieldSet"];
...
export type PersonPredicateFilter =
  components["schemas"]["PersonPredicateFilter"];
export type PersonPredicateQuery =
  components["schemas"]["PersonPredicateQuery"];
export type PersonUpdate = components["schemas"]["PersonUpdate"];
export type Picogram = components["schemas"]["Picogram"];
export type PicogramConcentration =
  components["schemas"]["PicogramConcentration"];
...
export type ProjectPredicateFilter =
  components["schemas"]["ProjectPredicateFilter"];
export type ProjectPredicateQuery =
  components["schemas"]["ProjectPredicateQuery"];
...
export type SampleMultiplexingOperator =
  components["schemas"]["SampleMultiplexingOperator"];
...
export type ServicePredicateFilter =
  components["schemas"]["ServicePredicateFilter"];
export type ServicePredicateQuery =
  components["schemas"]["ServicePredicateQuery"];
...
export type SpecimenMeasurementData =
  components["schemas"]["SpecimenMeasurementData"];
export type SpecimenPredicate = components["schemas"]["SpecimenPredicate"];
export type SpecimenPredicateFilter =
  components["schemas"]["SpecimenPredicateFilter"];
export type SpecimenPredicateQuery =
  components["schemas"]["SpecimenPredicateQuery"];
export type SpecimenType = components["schemas"]["SpecimenType"];
export type SpecimenTypeOperator =
  components["schemas"]["SpecimenTypeOperator"];
...
export type SuspensionConcentration =
  components["schemas"]["SuspensionConcentration"];
export type SuspensionContent = components["schemas"]["SuspensionContent"];
export type SuspensionContentOperator =
  components["schemas"]["SuspensionContentOperator"];
...
export type SuspensionMeasurement =
  components["schemas"]["SuspensionMeasurement"];
export type SuspensionMeasurementData =
  components["schemas"]["SuspensionMeasurementData"];
export type SuspensionMeasurementQuantity =
  components["schemas"]["SuspensionMeasurementQuantity"];
export type SuspensionPoolCompact =
  components["schemas"]["SuspensionPoolCompact"];
export type SuspensionPoolDetailed =
  components["schemas"]["SuspensionPoolDetailed"];
...
export type SuspensionPoolMeasurement =
  components["schemas"]["SuspensionPoolMeasurement"];
export type SuspensionPoolPredicate =
  components["schemas"]["SuspensionPoolPredicate"];
export type SuspensionPoolPredicateFilter =
  components["schemas"]["SuspensionPoolPredicateFilter"];
export type SuspensionPoolPredicateInner =
  components["schemas"]["SuspensionPoolPredicateInner"];
export type SuspensionPoolPredicateQuery =
  components["schemas"]["SuspensionPoolPredicateQuery"];
export type SuspensionPoolUpdate =
  components["schemas"]["SuspensionPoolUpdate"];
export type SuspensionPredicate = components["schemas"]["SuspensionPredicate"];
export type SuspensionPredicateFilter =
  components["schemas"]["SuspensionPredicateFilter"];
export type SuspensionPredicateInner =
  components["schemas"]["SuspensionPredicateInner"];
export type SuspensionPredicateQuery =
  components["schemas"]["SuspensionPredicateQuery"];
export type SuspensionSpecimenFields =
  components["schemas"]["SuspensionSpecimenFields"];
...
export type ThermalPreservationMethod =
  components["schemas"]["ThermalPreservationMethod"];
export type ThermalPreservationMethodOperator =
  components["schemas"]["ThermalPreservationMethodOperator"];
...
export type UpdateChromiumDatasetError =
  components["schemas"]["UpdateChromiumDatasetError"];
...
type FlattenedDeepRequired<T> = {
  [K in keyof T]-?: FlattenedDeepRequired<
    T[K] extends unknown[] | undefined | null ? Extract<T[K], unknown[]>[number]
      : T[K]
  >;
};
type ReadonlyArray<T> = [
  ...
  : Readonly<Exclude<T, undefined>[]>;
export const actionValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Action"]
> = ["create", "update", "delete"];
export const apiKeyFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ApiKeyField"]
> = [
  "id",
  "description",
  "owner_id",
...
export const apiKeyLocationValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ApiKeyLocation"]
> = ["query", "header", "cookie"];
export const blockEmbeddingMatrixValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["BlockEmbeddingMatrix"]
> = [
  "carboxymethyl_cellulose",
  "optimal_cutting_temperature_compound",
  "paraffin",
];
export const cdnaFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["CdnaField"]
> = [
  "id",
  "readable_id",
  "library_type",
...
export const chromiumDatasetFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ChromiumDatasetField"]
> = ["id", "name", "delivered_at"];
export const chromiumRunFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ChromiumRunField"]
> = [
  "id",
  "readable_id",
  "assay_id",
...
export const controlledRateFreezingValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ControlledRateFreezing"]
> = ["controlled_rate_freezing"];
export const cookieStyleValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["CookieStyle"]
> = ["form"];
export const countingMethodValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["CountingMethod"]
> = ["bright_field", "acridine_orange_propidium_iodide", "trypan_blue"];
export const dithiobisSuccinimidylpropionateValues: ReadonlyArray<
  FlattenedDeepRequired<
    components
  >["schemas"]["DithiobisSuccinimidylpropionate"]
> = ["dithiobis_succinimidylpropionate"];
export const flashFreezingValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["FlashFreezing"]
> = ["flash_freezing"];
export const formaldehydeDerivativeValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["FormaldehydeDerivative"]
> = ["formaldehyde_derivative"];
export const headerStyleValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["HeaderStyle"]
> = ["simple"];
export const institutionFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["InstitutionField"]
> = ["id", "name", "microsoft_entra_tenant_id"];
export const libraryFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["LibraryField"]
> = [
  "id",
  "readable_id",
  "cdna_id",
...
export const libraryTypeValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["LibraryType"]
> = [
  "antibody_capture",
  "antigen_capture",
  "chromatin_accessibility",
...
export const microliterValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Microliter"]
> = ["microliter"];
export const micrometerValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Micrometer"]
> = ["micrometer"];
export const milliliterValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Milliliter"]
> = ["milliliter"];
export const multiplexingTagTypeValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["MultiplexingTagType"]
> = [
  "flex_barcode",
  "flex_oligonucleotide_barcode",
  "TotalSeq-A",
...
export const nanogramValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Nanogram"]
> = ["nanogram"];
export const ocmBarcodeIdValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["OcmBarcodeId"]
> = ["ob1", "ob2", "ob3", "ob4"];
export const pathStyleValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["PathStyle"]
> = ["matrix", "label", "simple"];
export const personFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["PersonField"]
> = ["id", "name", "email", "institution_id", "is_staff", "orcid"];
export const picogramValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Picogram"]
> = ["picogram"];
export const projectFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ProjectField"]
> = ["id", "name", "created_by", "started_at", "ended_at"];
export const queryStyleValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["QueryStyle"]
> = ["form", "spaceDelimited", "pipeDelimited", "deepObject"];
export const resourceValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Resource"]
> = [
  "institution",
  "person",
  "account",
...
export const sampleMultiplexingValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SampleMultiplexing"]
> = [
  "cellplex",
  "flex_barcode",
  "flex_oligonucleotide_barcode",
...
export const serviceFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["ServiceField"]
> = ["id", "description", "owned_by", "is_staff", "created_at"];
export const speciesValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["Species"]
> = [
  "ambystoma_mexicanum",
  "canis_familiaris",
  "callithrix_jacchus",
...
export const specimenFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SpecimenField"]
> = [
  "id",
  "readable_id",
  "name",
...
export const specimenTypeValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SpecimenType"]
> = ["block", "cell_pellet", "rna_extract", "suspension", "tissue"];
export const suspensionContentValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SuspensionContent"]
> = ["cells", "nuclei"];
export const suspensionFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SuspensionField"]
> = [
  "id",
  "readable_id",
  "specimen_id",
...
export const suspensionPoolFieldValues: ReadonlyArray<
  FlattenedDeepRequired<components>["schemas"]["SuspensionPoolField"]
> = ["id", "readable_id", "name", "pooled_at", "additional_data"];

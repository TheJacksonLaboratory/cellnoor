...
create function sort_assay_arrays() returns trigger language plpgsql volatile as $$
    begin
...
create trigger sort_assay_arrays before insert or update on tenx_assay for each row execute function
sort_assay_arrays();

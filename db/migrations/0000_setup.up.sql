...
create or replace function create_person_user_if_not_exists(
    ...
    begin
        ...
        execute format('grant select on person_public, person_to_institution, project, project_access, project_to_people, specimen, suspension_to_specimen, suspension_pool_to_specimen, gem_pool_to_specimen, cdna_to_specimen, library_to_specimen, chromium_dataset_to_specimen to %I', username);
